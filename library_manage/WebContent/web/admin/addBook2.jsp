...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" id="formSubmit"  action="${pageContext.request.contextPath }/book/addBookDetail.do" method="post">
                  <div class="layui-form-item">
                      <label for="username" class="layui-form-label">
                          <span class="x-red">*</span>ISBN
                      </label>
                      <div class="layui-input-inline">
                          <input type="text" id="inputISBN" name="isbn" required="" lay-verify="required"
                ...
                <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="inputBookname" name="bookname" required="" lay-verify="phone"
                          autocomplete="off" class="layui-input">
                      </div>
                        <div class="layui-form-mid layui-word-aux">
                  ...
                  <div class="layui-form-item">
                      <label class="layui-form-label"><span class="x-red">*</span>出版社</label>
                        <div class="layui-input-inline">
                          <input type="text" id="inputPublish" name="publish" required="" lay-verify="pass"
                          autocomplete="off" class="layui-input">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="inputPublishdate" name="publishdate" 
                           class="layui-input">
                      </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="inputUnitprice" name="unitprice" required="" lay-verify="repass"
                          autocomplete="off" class="layui-input">
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="inputPrintnum" name="printnum" required="" lay-verify="repass"
                          autocomplete="off" class="layui-input">
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="inputNum" name="num" required="" lay-verify="repass"
                          autocomplete="off" class="layui-input">
                      </div>
                      <div class="layui-form-mid layui-word-aux">
