...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" id="formSubmit" action="${pageContext.request.contextPath }/book/addBooktypeDetail.do" method="post">
                  <div class="layui-form-item">
                      <label for="username" class="layui-form-label">
                          <span class="x-red">*</span>图书类别名称
                      </label>
                      <div class="layui-input-inline">
                          <input type="text" id="inputTypename" name="typename"
