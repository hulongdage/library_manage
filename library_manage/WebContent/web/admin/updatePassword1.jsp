...
<html class="x-admin-sm">
    ...
    <body>
        <div class="x-nav">
         ...
         <form class="layui-form" id="updateAdminPasswordForm" onsubmit="return submitForm(this);" action="${pageContext.request.contextPath }/user/updateAdminPassword.do" method="post">
