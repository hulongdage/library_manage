                           ...
                           <form class="layui-form layui-col-space5" id="searchBookForm" onsubmit="return false" action="##" method="post">
                               <input type="hidden" id="loadNum" value=1>
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" id="inputBookname" name="bookname"  placeholder="请输入图书名称" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
    ...
    function displayData(data){
    	...
    	for( i in data ){	
    		str += '<tr>'+
		       ...
		       '<button class="layui-btn" onclick="xadmin.open('+"'修改图书信息'"+','+"'${pageContext.request.contextPath}/book/showBookDetail.do?isbn="+data[i].isbn+"'"+',600,400)">'+
		       '<i class="layui-icon"></i>修改</button></div></td>'+ 
		       '<td><a title="删除" onclick="del(this,'+data[i].isbn+')" href="javascript:;"><i class="layui-icon">&#xe640;</i></a></td>'+   
		       '</tr>';    		   
    	}
    	tbody.innerHTML = str;
    }
