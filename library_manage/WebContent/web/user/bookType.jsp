			...
			<div class="navbar-container" id="navbar-container">
               ...
               <ul class="nav ace-nav">	
				...
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
				 <span  class="time"><em id="time"></em></span><span class="badge" id="showName"></span>
...
<script type="text/javascript">
                    ...
                    <li class="home"><a href="<%=request.getContextPath()%>/web/user/modifyUser.jsp" name="modifyUser.jsp" title="修改个人信息"  class="iframeurl"><i class="icon-double-angle-right"></i>修改个人信息</a></li>
</ul>
				     </li>
                   <li>
				   <a href="#" class="dropdown-toggle"><i class="icon-credit-card"></i><span class="menu-text"> 图书借阅排行榜 </span><b class="arrow icon-angle-down"></b></a>
				     <ul class="submenu">
						<li class="home"><a href="<%=request.getContextPath()%>/web/user/bookpie.jsp" title="图书种类分布" class="iframeurl"><i class="icon-double-angle-right"></i>图书种类分布</a></li>
						 <li class="home"><a href="<%=request.getContextPath()%>/web/user/bookzhuzhuangtu.jsp" name="bookzhuzhuangtu.jsp" title="图书借阅统计" class="iframeurl"><i class="icon-double-angle-right"></i>图书借阅统计</a></li>
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="bookType1.jsp">  </iframe>
