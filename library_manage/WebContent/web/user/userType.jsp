                ...
                <script type="text/javascript">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"><span class="Current_page iframeurl">基础信息维护</span></li>
                            <li class="active" id="parentIframe"><span class="parentIframe iframeurl">读者类别设置</span></li>
							
						</ul>
					</div>
                    
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="userType1.jsp">  </iframe>
