...
<html class="x-admin-sm">
  ...
  <form class="layui-form" id="updateAdminDetailForm" onsubmit="return submitForm(this);" action="${pageContext.request.contextPath }/user/updateUserDetail.do" method="post" enctype="multipart/form-data">
