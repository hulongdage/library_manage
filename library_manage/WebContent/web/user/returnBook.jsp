                ...
                <script type="text/javascript">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"><span class="Current_page iframeurl">图书借阅管理</span></li>
                            <li class="active" id="parentIframe"><span class="parentIframe iframeurl">图书归还</span></li>
							
						</ul>
					</div>
                    
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="returnBook1.jsp">  </iframe>
